...
//DEFENSA DEL CÓDIGO 31/01/2022
function masVisit3($vueloDestino){
    $cuentaRoma=0;
    $cuentaMilan=0;
    $cuentaMad=0;
    $cuentaLim=0;
...
echo "Las 3 ciudades más visitadas son: ";
$masVisit = array_slice($ciudades,3);
rsort($masVisit);
foreach ($masVisit as $cuenta) {
    $masCiu=$cuenta["Ciudad"];
    echo $masCiu . "//"; 
}
}

//EJERCICIO 2
function horTot($vueloDuracion, $id){
    $numero=0;
foreach ($vueloDuracion as $duracion) {
$avion=$duracion["Avion"];
...
echo "Horas totales de vuelo: " . $numero/60 . " horas <br>";
}

//EJERCICIO 6
function mediaMinAvion($vueloDuracion,$id){
    $numero=0;
    $contador=0;
    foreach ($vueloDuracion as $duracion) {
        $minutos=$duracion["Minutos"];
    ...
    $numero=$numero/$contador;
    echo "Media de minutos volados: " . $numero . " minutos<br>";
}
?>